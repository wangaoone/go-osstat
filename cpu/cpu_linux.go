...
// Get cpu statistics
func Get(numCores int) ([]*Stats, error) {
	...
	defer file.Close()
	return collectCPUStats(numCores, file)
}
...
func collectCPUStats(numCores int, out io.Reader) ([]*Stats, error) {
	scanner := bufio.NewScanner(out)
	res := make([]*Stats, numCores)
